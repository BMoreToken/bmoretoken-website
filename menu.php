...
<html lang="en">
  <head>
	...
	<script src="https://cdn.datatables.net/1.10.24/js/dataTables.bootstrap4.min.js" crossorigin="anonymous"></script>
    	<title><?PHP if (isset($title)){ echo $title; }else{ $title = 'BMoreToken (BALT)';  echo $title;  } ?></title>
	<meta property="og:image"         content="https://www.bmoretoken.com/logo.png" />
	<!-- Global site tag (gtag.js) - Google Analytics -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-GKSG7W3XGG"></script>
	<script>
